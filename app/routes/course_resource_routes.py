...
async def upload_resource(
    ...
    try:
        resource_doc = await course_resource_service.process_resource(db, resource_doc)
    except Exception:
        resource_doc = await db.course_resources.find_one({"_id": result.inserted_id}) or resource_doc
